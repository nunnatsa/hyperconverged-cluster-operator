...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataImportCroneStatus) DeepCopyInto(out *DataImportCroneStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataImportCroneStatus.
func (in *DataImportCroneStatus) DeepCopy() *DataImportCroneStatus {
	if in == nil {
		return nil
	}
	out := new(DataImportCroneStatus)
	in.DeepCopyInto(out)
	return out
}
