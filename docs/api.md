...
* [DataImportCroneStatus](#dataimportcronestatus)
...
| Field | Description | Scheme | Default | Required |
| ----- | ----------- | ------ | -------- |-------- |
| status |  | [DataImportCroneStatus](#dataimportcronestatus) |  | false |

[Back to TOC](#table-of-contents)

## DataImportCroneStatus

DataImportCroneStatus is the status field of the DIC template
