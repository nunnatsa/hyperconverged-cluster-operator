...
require (
	...
	kubevirt.io/kubevirt v0.30.0
	sigs.k8s.io/controller-runtime v0.6.0
)

// Pinned to kubernetes-1.16.4 to kubevirt.io/kubevirt v0.30.0
replace (
...
replace (
	...
	kubevirt.io/client-go => kubevirt.io/client-go v0.30.0
)
...
// to kubernetes-1.16.4  as for kubevirt.io/kubevirt v0.30.0
